            ...
            <div class="flex flex-wrap-reverse items-end">
              <div class="w-full md:w-3/5">
                <h3 class="text-xl md:text-2xl leading-10 font-regular my-4">
                  ...
                  Bengaluru working at
                  <a
                    target="_blank"
                    class="text-primary underline pr-2"
                    href="https://codilar.com/"
                    >Codilar Technologies Pvt. Ltd</a
...
<script>
import Feature1Icon from "../Icons/feature1.vue";
import Feature2Icon from "../Icons/feature2.vue";
import Feature3Icon from "../Icons/feature3.vue";
export default {
  components: {
    Feature1Icon,
    Feature2Icon,
